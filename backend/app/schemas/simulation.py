...
class ScenarioCreate(BaseModel):
    ...
    loop: bool = False
    spawn_schedule: list[dict] = []
    removed_instance_ids: list[str] = []
    spawned_instance_ids: list[str] = []
...
class ScenarioUpdate(BaseModel):
    ...
    spawn_schedule: Optional[list[dict]] = None
    removed_instance_ids: Optional[list[str]] = None
    spawned_instance_ids: Optional[list[str]] = None
...
class ScenarioOut(BaseModel):
    ...
    loop: bool = False
    spawn_schedule: list = []
    removed_instance_ids: list = []
    spawned_instance_ids: list = []
