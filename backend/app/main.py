    ...
    try:
        ...
        with engine.connect() as conn:
            for stmt in [
                ...
                "ALTER TABLE sim_scenarios ADD COLUMN IF NOT EXISTS spawn_schedule JSON DEFAULT '[]'",
                "ALTER TABLE sim_scenarios ADD COLUMN IF NOT EXISTS removed_instance_ids JSON DEFAULT '[]'",
                "ALTER TABLE sim_scenarios ADD COLUMN IF NOT EXISTS spawned_instance_ids JSON DEFAULT '[]'",
